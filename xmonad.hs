...
myStartupHook = do
    ...
    spawnOnce "feh --bg-fill ~/Downloads/b8a274be-e1b2-459e-9f6c-f3d83c334b57.jpg"  -- feh set random wallpaper
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/vise/.config/xmobar/xmobarrc"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/vise/.config/xmobar/xmobarrc"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/vise/.config/xmobar/xmobarrc"
